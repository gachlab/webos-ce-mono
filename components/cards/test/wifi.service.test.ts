...
//
// The scenarios are the ones the card before it had (components/wifi-app on
// enyo's lib/wifi), and the payloads and replies are the ones
// components/nm-connectionmanager sends.

import assert from "node:assert/strict";
import { describe, test } from "node:test";

import { createFakeLuna, type FakeLuna } from "#lib/infra/luna/fake.service.ts";
import { canJoin, canSaveAddress, createWifiService, isAddress, joinFailureText, maskFor,
         SCAN_MS, type WifiService } from "#lib/services/wifi.service.ts";
import type { Payload } from "#lib/infra/luna/service.ts";
